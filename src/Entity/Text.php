...
class Text
{
    public function __construct($quoteDependencies, $quoteAttributes)
    {
        ...
        {
            return str_replace($quoteAttributes['destination_link'], $quoteDependencies['usefulObject']->url . '/' . $quoteDependencies['destination']->countryName . '/quote/' . $quoteDependencies['_quoteFromRepository']->id, $quoteDependencies['text']);
        }
        return str_replace($quoteAttributes['destination_link'], '', $quoteDependencies['text']);
    }
